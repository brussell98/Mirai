...
var commands = {
	"help": {
		...
		process: function(bot, msg, suffix) {
			...
			if (!suffix) {
				...
				toSend.push("You can also find examples and more at __github.com/brussell98/BrussellBot/wiki/Commands__");
	...
	"info": {
		...
		process: function(bot, msg, suffix) {
			...
			} else bot.sendMessage(msg, "⚠ Can't do that in a DM.", (erro, wMessage) => { bot.deleteMessage(wMessage, {"wait": 8000}); });
		}
	},
	"avatar": {
